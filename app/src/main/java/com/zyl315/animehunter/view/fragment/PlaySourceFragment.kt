...
class PlaySourceFragment : BaseBottomFragment<FragmentPlaySourceBinding>() {
    ...
    override fun onCreateView(
        ...
        mBinding.run {
            rvPlayUrlList.layoutManager = GridLayoutManager(requireActivity(), 3, RecyclerView.VERTICAL, false)
            rvPlayUrlList.adapter = mPlaySourceAdapter

            ivClose.setOnClickListener{this@PlaySourceFragment.dismiss()}
        }
